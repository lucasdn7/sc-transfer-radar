-- Migração completa para gerenciar updated_at da tabela processes
-- O updated_at deve ser atualizado quando:
-- 1. O próprio processo for modificado
-- 2. Parcelas do processo forem inseridas/atualizadas/deletadas
-- 3. Termos aditivos do processo forem inseridos/atualizados/deletadas
